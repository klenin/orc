...
//func loadParams() {
//	paramNames, _ := ioutil.ReadFile("./resources/param-name")
//	paramNamesSourse := strings.Split(string(paramNames), "\n")
//	for i := 0; i < len(paramNamesSourse); i++ {
//		paramName := strings.TrimSpace(paramNamesSourse[i])
//		entity := base.Params()
//		entity.Insert(entity.GetColumnSlice(1), []interface{}{paramName})
//	}
//}
