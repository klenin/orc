...
func SendEmailWelcomeToProfile(to, address, token string) bool {
    log.Println("SendEmailWelcomeToProfile: address: ", address)
    log.Println("SendEmailWelcomeToProfile: to: ", to)
